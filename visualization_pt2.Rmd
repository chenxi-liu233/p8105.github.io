...
There are ways to set color preferences globally as well (for example, to use `viridis` color palettes everywhere, all the time), although they're a bit more involved. 
